                                    ...
                                    <div className="p-6 flex-1 flex flex-col">
                                        ...
                                        <div className="flex justify-between items-center mt-5 pt-4 border-t border-gray-100">
                                            ...
                                            <button
                                                ...
                                                className={`px-3 py-1.5 rounded-full text-sm font-medium flex items-center gap-1 ${pub.guardado ? 'bg-amber-100 text-amber-800' : 'bg-gray-100 text-gray-700 hover:bg-gray-200'} transition-all duration-300`}
                                            >
                                                {pub.guardado ? (
                                                    <>
                                                        <svg xmlns="http://www.w3.org/2000/svg" className="h-4 w-4" viewBox="0 0 20 20" fill="currentColor">
